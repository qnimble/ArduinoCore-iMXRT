...
#ifndef __NOR_BOOT_H__
#define __NOR_BOOT_H__
...
#define APPLICATION_BOOT_HEADER2 0x688A3B00
#define APPLICATION_BOOT_HEADER_AND_VERSION APPLICATION_BOOT_HEADER2 + APPLICATION_VERSION
...
#define IMAGE_ENTRY_ADDRESS ((uint32_t) g_pfnVectors)
